...
#define VER_FILEDESCRIPTION_STR     "SDImageGenerator 0.1.0\0"
...
#define VER_PRODUCTNAME_STR         "SDImageGenerator\0"
#define VER_COMPANYDOMAIN_STR       "https://github.com/rupeshs"
